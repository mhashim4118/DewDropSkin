...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'bv_bonus'                         =>    'required|integer|gt:0',
            'pv_bonus'                         =>    'numeric|gt:0',
        ...
        $product->bv = $request->bv_bonus;
        $product->bv_formula = $request->bv_formula;
        //$product->bv_per = $request->pv_formula;
        $product->pv = $request->pv_bonus;
        $product->pv_formula = $request->pv_formula;
		$product->shop_reference = $request->shop_reference;
