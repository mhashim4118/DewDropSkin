...
class SiteController extends Controller
{
    ...
    public function CheckUsername(Request $request)
    {
        ...
        if (empty($id)) {
            ...
            return response()->json(['is_active'=>0,'success' => false, 'msg' => "<span class='help-block'><span class='text-danger'>This user has not purchased any dsp plan yet</span></span>
    ...
    public function productDetails($id){
		...
		$product->meta_keyword = explode(',', $product->meta_keyword);
