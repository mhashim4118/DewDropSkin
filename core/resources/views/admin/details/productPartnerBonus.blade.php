                    ...
                    <table class="table table--light style--two">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('Product Partner Bonus')</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Product Partner Bonus')">{{number_format($product->product_partner_bonus, 2) }} PKR </td>
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.users.productPartnerBonus')}}" method="GET" class="form-inline float-sm-right bg--white">
