                    ...
                    <table class="table table--light style--two">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('E-Pin Credit')</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('E-Pin Credit')">{{number_format($product->epin_credit, 2) }} PKR </td>
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.users.EPinCredit')}}" method="GET" class="form-inline float-sm-right bg--white">
