                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Stockist Reference Bonus')">{{number_format($product->stockist_ref_bonus, 2) }} PKR </td>
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.users.stockistReferenceBonus')}}" method="GET" class="form-inline float-sm-right bg--white">
