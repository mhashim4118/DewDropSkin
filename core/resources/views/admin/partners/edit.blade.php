...
@section('panel')
<form action="{{ route('admin.report.update_partner',@$price_list->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row mb-5">
            ...
            <div class="card">
               <div class="card-body">
                    <div class="form-group row">
                        <div class="col-md-2">
                            <label for="name" class="font-weight-bold">@lang('Partner Name') <strong class="text-danger">*</strong> </label>
                        </div>
                        <div class="col-md-10">
                            <input type="text" autofocus class="form-control" name="name" id="name" value="{{ $price_list->name }}" placeholder="@lang('Name')">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-2">
                            <label for="" class="font-weight-bold">@lang('Percentage') <strong class="text-danger">*</strong> </label>
                        </div>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="PV" name="percentage"  value="{{ $price_list->percentage }}"placeholder="@lang('Enter PV')">
                        </div>
                    </div>
...
<a href="{{ route('admin.report.partner_earnings') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="las la-backward"></i>@lang('Back')</a>
