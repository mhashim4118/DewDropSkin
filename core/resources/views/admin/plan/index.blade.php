                    ...
                    <div class="table-responsive--md table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr>
								...
								<th scope="col">@lang('Retail Price')</th>
                            ...
                            @forelse($plans as $key => $plan)
                                <tr>
									...
									<td data-label="@lang('Retail Price')">{{ getAmount($plan->retail_price) }} {{$general->cur_text}}</td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <button type="button" class="icon-btn edit" data-toggle="tooltip"
                                                ...
                                                data-bv="{{ $plan->bv }}"
												data-retail_price="{{ getAmount($plan->retail_price) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
							 ...
							 <div class="form-group col-md-4">
                                <label class="font-weight-bold"> @lang('Retail Price') </label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span
                                            class="input-group-text">{{$general->cur_sym}} </span></div>
                                    <input type="text" class="form-control  retail_price" name="retail_price" required>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
