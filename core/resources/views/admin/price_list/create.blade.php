...
@section('panel')
<form action="{{ route('admin.price-list.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row mb-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" autofocus class="form-control" name="product_name" id="name" value="{{ old('name') }}" placeholder="@lang('Name')">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="PV" name="pv" placeholder="@lang('Enter PV')">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="BV" name="bv" placeholder="@lang('Enter BV')">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="price" name="price" placeholder="@lang('Price')">
                        </div>
                    </div>
