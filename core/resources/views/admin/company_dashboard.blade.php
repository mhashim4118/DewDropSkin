...
@section('panel')
    ...
    <a href="javascript:void(0)"
        class="matrixSetting btn btn--dark text-light text--small my-2 box--shadow3 mt-3">@lang('Clear Wallet')</a>
    ...
    <div class="row mb-30">
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--primary b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->company_wallet, 2) }} PKR</span>

                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Company Wallet')</span>
                    </div>


                    <a href="javascript:void(0)"
                        class="matrixSettingl btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('Clear Wallet')</a>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->users_wallet, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Users Wallet')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--orange b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->total_collection, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Collected Earning')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span
                            class="amount">{{ showAmount($admin_wallets->distributedAmount + $paymentWithdraw['total_withdraw_amount']) }}
                            PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Distributed Amount')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">0.00 PKR</span>
                        <p class="text-light">Total : {{ number_format($admin_wallets->dSPBalance, 2) }} PKR</p>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('DSP Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">0.00 PKR</span>
                        <p class="text-light">Total : {{ number_format($admin_wallets->directReferenceBalance, 2) }} PKR
                        </p>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Direct Reference Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->rewardBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Reward Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->pairBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Pair Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->weeklyPromoBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Weekly Promo Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->e_PinStockistBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Epin Stokist Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->pintaPayBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('PintaPay Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->productsBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Products Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->shippingBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Shipping Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->eventBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Event Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->samiExpenseBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Sami Expense Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->officeBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Office Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->visitOutsideBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Visit Outside Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->iTBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('IT Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($admin_wallets->extraBalance, 2) }} PKR</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Extra Balance')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <a href="{{ route('admin.users.walletStatements') }}"
                            class="btn btn-sm text--small bg--white text--black box--shadow3 mt3">
                            @lang('View Wallets Statements')
                        </a>
                    </div>
    ...
    <div id="matrixSettingModall" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.wallet-clear') }}" method="GET">
                    @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.wallet-clear') }}" method="GET">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="matrix_height" class="form-control-label font-weight-bold">@lang('Select Wallet') <sup
                                    class="text--danger">*</sup></label>
                            <select name="wallet" class="form-control " required>
                                <option value="0">--Select Wallet--</option>
                                <option value="PPB">PintaPay Balance</option>
                                <option value="PB">Products Balance</option>
                                <option value="SB">Shipping Balance</option>
                                <option value="EB">Event Balance</option>
                                <option value="SEB">Sami Expense Balance</option>
                                <option value="OB">Office Balance</option>
                                <option value="VOB">Visit Outside Balance</option>
                                <option value="ITB">IT Balance</option>
                                <option value="ExB">Extra Balance</option>
                            </select>


                        </div>
                        <div class="form-group">
                            <label for="matrix_height" class="form-control-label font-weight-bold">@lang('Amount') <sup
                                    class="text--danger">*</sup></label>
                        ...
                        <div class="form-group">
                            <label for="matrix_height" class="form-control-label font-weight-bold">@lang('Note') <sup
                                    class="text--danger">*</sup></label>
                            <input type="text" class="form-control form-control-lg" name="note"
                                placeholder="@lang('Enter a Note')" required="">
            ...
            <div class="row mb-none-30">
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--success text-white">
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{ showAmount($payment['total_deposit_amount']) }}
                                {{ $general->cur_text }}</h2>
                            <p class="text--small">@lang('Total Deposit')</p>
                            <h2 class="numbers text-white"><br>{{ showAmount($payment['total_deposit_charge']) }}
                                {{ $general->cur_text }}</h2>
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--danger text-white">
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{ showAmount($paymentWithdraw['total_withdraw_amount']) }}
                                {{ $general->cur_text }}</h2>
                            <p class="text--small">@lang('Total Withdraw')</p>
                            <h2 class="numbers text-white">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group ">
                                ...
                                <div class="input-group-append" id="copybtn">
                                    <span class="input-group-text btn--success" title="" onclick="myFunction()">
                                        @lang('COPY')</span>
                                </div>
                            </div>
                        </div>
...
@push('script')
    ...
    <script>
        "use strict";
        $('.matrixSettingl').on('click', function() {
            $('#matrixSettingModall').modal('show');
        });
    </script>
@endpush