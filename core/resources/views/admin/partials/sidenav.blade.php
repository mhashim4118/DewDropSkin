<div class="sidebar {{ sidebarVariation()['selector'] }} {{ sidebarVariation()['sidebar'] }} {{ @sidebarVariation()['overlay'] }} {{ @sidebarVariation()['opacity'] }}"
    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{route('admin.dashboard.company')}}" class="sidebar__main-logo"><img
                    src="{{getImage(imagePath()['logoIcon']['path'] .'/logo.png')}}" alt="@lang('image')"></a>
            <a href="{{route('admin.dashboard.company')}}" class="sidebar__logo-shape"><img
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.dashboard*',3)}}">
                        <i class="menu-icon las la-home"></i>
                        <span class="menu-title">@lang('Dashboard')</span>

                        
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.dashboard*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.dashboard.company')}} ">
                                <a href="{{route('admin.dashboard.company')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Company')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.dashboard.users')}} ">
                                <a href="{{route('admin.dashboard.users')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Users')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.dashboard.expense')}} ">
                                <a href="{{route('admin.dashboard.expense')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.summary*')}}">
                    <a href="{{route('admin.summary')}}" class="nav-link ">
                        <i class="menu-icon las la-paper-plane"></i>
                        <span class="menu-title">@lang('Summary')</span>
                    </a>
                </li>
				<li class="sidebar-menu-item {{menuActive('admin.calculator*')}}">
                    <a href="{{route('admin.calculator')}}" class="nav-link ">
                        <i class="menu-icon las la-paper-plane"></i>
                        <span class="menu-title">@lang('Calculator')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.report.partner_earnings')}}">
                    <a href="{{route('admin.report.partner_earnings')}}" class="nav-link ">
                        <i class="menu-icon las la-paper-plane"></i>
                        <span class="menu-title">@lang('Partner Earnings')</span>
                    </a>
                </li>
				<li class="sidebar-menu-item {{menuActive('admin.plan*')}}">
                    <a href="{{route('admin.lucky_draws')}}" class="nav-link ">
                        <i class="menu-icon las la-paper-plane"></i>
                        <span class="menu-title">@lang('Lucky Draw Winners')</span>
                    </a>
                </li>
				<li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.stockists*',3)}}">
                        <i class="menu-icon las la-credit-card"></i>
                        <span class="menu-title">@lang('Stockist')</span>

                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.stockists*',2)}} ">
                        <ul>

                            <li class="sidebar-menu-item {{menuActive('admin.stockists')}} ">
                                <a href="{{route('admin.stockists')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Stockist')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.stockist.list')}} ">
                                <a href="{{route('admin.stockist.list')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.price-list*')}}">
                    <a href="{{route('admin.price-list.index')}}" class="nav-link ">
                        <i class="menu-icon lab la-product-hunt"></i>
                        <span class="menu-title">@lang('Price List')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.orders.*',3)}}">
                        ...
                        <span class="menu-title">@lang('Product Orders')</span>

                        
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.orders*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.orders.admin_orders')}} ">
                                <a href="{{route('admin.orders.admin_orders')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Admin Orders')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.orders.seller_orders')}} ">
                                <a href="{{route('admin.orders.seller_orders')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Seller Orders')</span>
                                </a>
                            </li>
				 ...
				 <li class="sidebar-menu-item {{menuActive('admin.reward-users*')}}">
                    <a href="{{route('admin.reward-users')}}" class="nav-link ">
                        <i class="menu-icon las la-cart-plus"></i>
                        <span class="menu-title">@lang('Reward Users')</span>
                    </a>
                </li>
