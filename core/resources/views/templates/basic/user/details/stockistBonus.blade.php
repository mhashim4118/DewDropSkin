...
<div class="row align-items-center">
    <h4 class="mb-2 col-lg-8">@lang('Stockist Bonus')</h4>
    <form action="{{ route('user.stockistBonus') }}" method="GET" class="col-lg-4 form-inline bg--white">
	  @csrf
	  <div class="row">
                    ...
                    <table class="transection-table-2">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('Stockist Bonus')</th>
