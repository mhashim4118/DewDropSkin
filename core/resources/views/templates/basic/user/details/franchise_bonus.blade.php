...
<div class="row align-items-center">
    <h4 class="mb-2 col-lg-8">@lang('Franchise Bonus')</h4>
    <form action="{{ route('user.franchise_bonus') }}" method="GET" class="col-lg-4 form-inline bg--white">
	  @csrf
	  <div class="row">
                    ...
                    <table class="transection-table-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Franchise Bonus')">{{number_format($product->amount, 2) }} PKR </td>
