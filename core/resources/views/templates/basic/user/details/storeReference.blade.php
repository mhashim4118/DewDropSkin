...
<div class="row align-items-center">
    <h4 class="mb-2 col-lg-8">@lang('Store Reference Bonus')</h4>
    <form action="{{ route('user.storeReference') }}" method="GET" class="col-lg-4 form-inline bg--white">
	  @csrf
	  <div class="row">
                    ...
                    <table class="transection-table-2">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('Store Reference')</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Store Reference')">{{number_format($product->amount, 2) }} PKR </td>
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.users.storeReference')}}" method="GET" class="form-inline float-sm-right bg--white">
