...
<div class="row align-items-center">
    <h4 class="mb-2 col-lg-8">@lang('PV')</h4>
    <form action="{{ route('user.pv') }}" method="GET" class="col-lg-4 form-inline bg--white">
	  @csrf
	  <div class="row">
                    ...
                    <table class="transection-table-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('PV')">{{number_format($product->amount, 2) }} </td>
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.users.pv')}}" method="GET" class="form-inline float-sm-right bg--white">
