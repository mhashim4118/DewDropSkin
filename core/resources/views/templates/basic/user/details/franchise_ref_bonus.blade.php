...
<div class="row align-items-center">
    <h4 class="mb-2 col-lg-8">@lang('Franchise Reference Bonus')</h4>
                    ...
                    <table class="transection-table-2">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('Franchise Reference Bonus')</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Franchise Reference Bonus')">{{number_format($product->amount, 2) }} PKR </td>
