...
<div class="row align-items-center">
    <h4 class="mb-2 col-lg-8">@lang('City Reference')</h4>
    <form action="{{ route('user.city_reference') }}" method="GET" class="col-lg-4 form-inline bg--white">
	  @csrf
	  <div class="row">
                    ...
                    <table class="transection-table-2">
                        <thead>
                            ...
                            <th scope="col">@lang('S No.')</th>
                                <th scope="col">@lang('City Reference Bonus')</th>
                        ...
                        <tbody>
                           ...
                           <td data-label="@lang('S No.')" >{{ ($references->total() - ($references->firstItem() + $key)) + 1}}</td>
                                <td data-label="@lang('City Reference Bonus')">{{number_format($product->amount, 2) }} PKR </td>
