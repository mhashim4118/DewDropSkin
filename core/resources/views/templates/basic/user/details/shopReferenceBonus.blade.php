...
<div class="row align-items-center">
    <h4 class="mb-2 col-lg-8">@lang('Store Reference')</h4>
    <form action="{{ route('user.store_ref_bonus') }}" method="GET" class="col-lg-4 form-inline bg--white">
	  @csrf
	  <div class="row">
                    ...
                    <table class="table table--light style--two">
                        <thead>
                            <tr>
                               <th scope="col">@lang('Username')</th>
                                ...
                                <th scope="col">@lang('Online Store Reference')</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Online Store Reference')">{{number_format($product->shop_reference, 2) }} PKR </td>
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.users.shopReference')}}" method="GET" class="form-inline float-sm-right bg--white">
