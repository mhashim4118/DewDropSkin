...
<div class="row align-items-center">
    <h4 class="mb-2 col-lg-8">@lang('Store Bonus')</h4>
    <form action="{{ route('user.storeBonus') }}" method="GET" class="col-lg-4 form-inline bg--white">
	  @csrf
	  <div class="row">
                        ...
                        <thead>
                            <tr>
                               <th scope="col">@lang('S No.')</th>
                                <th scope="col">@lang('Store Bonus')</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td data-label="@lang('S No.')" >{{ ($references->total() - ($references->firstItem() + $key)) + 1}}</td>
                                <td data-label="@lang('Store Bonus')">{{number_format($product->amount, 2) }} PKR </td>
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.users.storeBonus')}}" method="GET" class="form-inline float-sm-right bg--white">
