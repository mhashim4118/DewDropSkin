        ...
        <div class="card rounded shadow border-0">
            <div class="card-body pt-5 pb-5 ">
                <div class="pricing-table text-center mb-4">
					<img style="width: 230px; margin: 0 " src="{{asset('assets/box/box.png')}}" alt="">
                    ...
                    <ul class="package-features-list mt-30">
                        <li><i class="las la-business-time __plan_info text--primary" data="bv"></i> <span>@lang('Direct Sale Bonus'): {{getAmount($data->bv)}} PKR</span> </li>
                        <li><i class="las la-comment-dollar __plan_info text--primary" data="ref_com"></i> <span> @lang('Referral Bonus'):   {{getAmount($data->ref_com)}} {{$general->cur_sym}}</span>
                        </li>
                        <li>
                            <i class="las la-comments-dollar __plan_info text--primary" data="tree_com"></i> <span>@lang('Pair Bonus'):  {{getAmount($data->bv)}} {{$general->cur_sym}}</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="form-group">
                    <div class="row ">
                        <div class="col-6 d-flex justify-content-center">
                            <input type="radio" id="html" name="fav_language" value="bank_account" checked>
                            <label for="html" style="padding-left: 4px;"> Current Balance </label>
                        </div>
                        <!--<div class="col-4 text-center ">
                            <input type="radio" id="css" name="fav_language" value="epin_credit">
                            <label for="css" style="padding-left: 4px;"> E-pin credit </label>
                        </div>-->
                        <div class="col-6  text-center">
                            <input type="radio" id="epinType" name="fav_language" value="epin">
                             <label for="epinType" style="padding-left: 4px;"> E-pin</label>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    (function($) {
        ...
        $('#epinType').on('click', function(e) {
            $(".modal-body").append(`<div class="form-group spdiv">
                    <label for="InputFirstname" class="col-form-label">E-Pin Number:</label>
                    <input type="text" class="form-control form--control" id="InputFirstname" name="sponser_id" autocomplete="OFF" value="" data-inputmask="'mask': '99-9999999'" placeholder="xxxxxxxxxxxx">
                </div>`);
            $(".subc-btn").show();
        });
